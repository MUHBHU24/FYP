...
SECRET_KEY = 'django-insecure-k&v*y)(44fofkya1usp*5%sx17h3#$s+@+di@7+_xru&+#^kko'
...
MEDIA_URL = 'fyp_backend/images/items/'
MEDIA_ROOT = os.path.join(BASE_DIR, 'fyp_backend/images/items/')